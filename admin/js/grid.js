	...
	window.Grid = Root.jQueryPlugin("grid",{
		...
		*******/
		...
		_afterLoad : function() {
			...
			if(this.opts.deleting) {
				...
				// add the column with a width
				var $deleteCol = this.addColumn("Borrar", {width: 65, cellClass : "center"}, function() {
		...
		_templates : {
			...
			pager : "\
				<div class='pagination left'>\
				  <ul>\
				  	<li class='disabled'>\
				  		<a href='#' class='pager_showing'>Mostrando \
				  			<span class='pager_lower_limit'>{{start}}</span> - \
				  			<span class='pager_upper_limit'>{{end}}</span>\
				  		</a></li>\
				    <li class='gridPrev'><a href='#'>Ant</a></li>\
				    <li class='gridNext'><a href='#'>Sig</a></li>\
				...
				<div class='right'>\
					<a class='disabled gridSave btn btn-primary' href='#'>Guardar</a>\
				<div>\
			"
		},
		...
		*/
		...
		deleteRow : function(e,el) {
			...
			this.confirm("Seguro que quieres borrar?", function() {
					...
					if(success) {
						...
						var fadeRow = function() {
							...
							if(self.opts.deleteConfirm) {
								self.alert("info", "Borrado!", "Row "+id+" ha sido borrado");
							}
						}
						// fade this row out
